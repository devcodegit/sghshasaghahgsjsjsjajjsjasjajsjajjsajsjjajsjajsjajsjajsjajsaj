#include "lazada_api_request_set_images.h"
...
LazadaApiRequestSetImages::LazadaApiRequestSetImages(IApiRequestListener *a_pListener)
{
    m_pApiRequestListener = a_pListener;
    m_sDomainUrl = DOMAIN_LAZADA;
    m_iRequestType = LazadaApiCommandDefined::LAZADA_REQ_SET_IMAGE;
}

void LazadaApiRequestSetImages::generateParams(QHash<QString, QString> *a_pParams)
{
    a_pParams->insert(QString("Action"), LazadaApiCommandDefined::LAZADA_ACTION_SET_IMAGE);

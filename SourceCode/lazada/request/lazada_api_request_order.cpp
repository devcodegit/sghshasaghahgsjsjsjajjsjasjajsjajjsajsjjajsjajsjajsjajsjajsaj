#include "lazada_api_request_order.h"
...
LazadaApiRequestOrder::LazadaApiRequestOrder(int orderId, IApiRequestListener *a_pListener)
{
...
void LazadaApiRequestOrder::generateParams(QHash<QString, QString> *a_pParams)
{

#include "lazada_api_request_user_update.h"
...
LazadaApiRequestUserUpdate::LazadaApiRequestUserUpdate(IApiRequestListener *a_pListener)
{
    m_pApiRequestListener = a_pListener;
    m_sDomainUrl = DOMAIN_LAZADA;
    m_iRequestType = LazadaApiCommandDefined::LAZADA_REQ_USER_UPDATE;
}

void LazadaApiRequestUserUpdate::generateParams(QHash<QString, QString> *a_pParams)
{
    a_pParams->insert(QString("Action"), LazadaApiCommandDefined::LAZADA_ACTION_USER_UPDATE);
